...
#define AVERAGE_POINTS			10LU
#define Z_THRESHOLD_12BIT		3
#define Z_THRESHOLD_08BIT		3

#define XPT2046_X_OFFSET 		22
#define XPT2046_Y_OFFSET		0

#define XPT2046_WIDTH			260
#define XPT2046_HEIGHT			340
/* This pins must be defined as in your project */

#define XPT2046_CS_Port 		TOUCH_CS_GPIO_Port
#define XPT2046_CS_Pin			TOUCH_CS_Pin
#define XPT2046_PENIRQ_Port 	TOUCH_IRQ_GPIO_Port
#define XPT2046_PENIRQ_Pin 		TOUCH_IRQ_Pin
