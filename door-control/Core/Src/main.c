...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LD1_Pin DOOR_SENSOR_TRIG_Pin LD3_Pin LD2_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|DOOR_SENSOR_TRIG_Pin|LD3_Pin|LD2_Pin;
